...
class HpMulti extends React.Component {
      ...
      if (event.key === "s" || event.key === "S") {
        if (this.state.hpPlayer1 >= (1)) {
          if (this.state.hpPlayer1 === this.state.maxLife) {
            ...
            this.state.hpPlayer1 + this.props.dammage * this.state.comboFactor1 >
            100
          ) {
            this.setState({
              hpPlayer1: 100
            ...
            this.setState({
              ...
              hpPlayer1:
                ...
                this.props.dammage * this.state.comboFactor1,
              dammageeffectL:
                "+" + this.props.dammage * this.state.comboFactor1 + " !"
            });
      ...
      if (event.key === "l" || event.key === "L") {
        if (this.state.hpPlayer2 >= (1)) {
          if (this.state.hpPlayer2 === this.state.maxLife) {
            ...
            this.state.hpPlayer2 + this.props.dammage * this.state.comboFactor2 >
            100
          ) {
            this.setState({
              hpPlayer2: 100
            ...
            this.setState({
              ...
              hpPlayer2:
                ...
                this.props.dammage * this.state.comboFactor2,
              dammageeffect2:
                "+" + this.props.dammage * this.state.comboFactor2 + " !"
            });
      ...
      if (event.key === "f" || event.key === "F") {
        if (this.state.hpPlayer3 >= (1)) {
          if (this.state.hpPlayer3 === this.state.maxLife) {
            ...
            this.state.hpPlayer3 + this.props.dammage * this.state.comboFactor3 >
            100
          ) {
            this.setState({
              hpPlayer3: 100
            ...
            this.setState({
              ...
              hpPlayer3:
                this.state.hpPlayer3 +
                this.props.dammage * this.state.comboFactor3,
              dammageeffectR:
                "+" + this.props.dammage * this.state.comboFactor3 + " !"
            });
      ...
      if (event.key === "j" || event.key === "J") {
        if (this.state.hpPlayer4 >= (1)) {
          if (this.state.hpPlayer4 === this.state.maxLife) {
            ...
            this.state.hpPlayer4 + this.props.dammage * this.state.comboFactor4 >
            100
          ) {
            this.setState({
              hpPlayer4: 100
            ...
            this.setState({
              ...
              hpPlayer4:
                this.state.hpPlayer4 +
                this.props.dammage * this.state.comboFactor4,
              dammageeffectR:
                "+" + this.props.dammage * this.state.comboFactor4 + " !"
            });
  ...
  render() {
    const Filler = props => {
      return (
        <div className="fillerLT" style={{ width: `${props.hpPlayer1}%` }} />
      );
    };
    const Filler1 = props => {
      return (
        <div className="fillerRT" style={{ width: `${props.hpPlayer2}%` }} />
      );
    };
    const Filler2 = props => {
      return (
        <div className="fillerLB" style={{ width: `${props.hpPlayer3}%` }} />
      );
    };
    const Filler3 = props => {
      return (
        <div className="fillerRB" style={{ width: `${props.hpPlayer4}%` }} />
      );
    };
    const Player2 = this.state.hpPlayer1 ? "barLeft" : "barLeft";
    const Player1 = this.state.hpPlayer2 ? "barRight" : "barRight";
    const Player3 = this.state.hpPlayer3 ? "barLeftBottom" : "barLeftBottom";
    const Player4 = this.state.hpPlayer4 ? "barRightBottom" : "barRightBottom";
    return (
      <div>
        ...
        {this.props.dammage > 0 ? <div className="deLCoolM">{this.state.dammageeffect1}</div> : <div className="deLPasCoolM">{this.state.dammageeffect1}</div>}
        {this.props.dammage > 0 ? <div className="deRCoolM">{this.state.dammageeffect2}</div> : <div className="deRPasCoolM">{this.state.dammageeffect2}</div>}
        {this.props.dammage > 0 ? <div className="deLBCoolM">{this.state.dammageeffect3}</div> : <div className="deLBPasCoolM">{this.state.dammageeffect3}</div>}
        {this.props.dammage > 0 ? <div className="deRBCoolM">{this.state.dammageeffect4}</div> : <div className="deRBPasCoolM">{this.state.dammageeffect4}</div>}
